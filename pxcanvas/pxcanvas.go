...
func (pxCanvas *PxCanvas) TryPen(previousCoord *fyne.PointEvent, ev *desktop.MouseEvent) {
...
func (pxCanvas *PxCanvas) NewDrawing(cols, rows int) {
	...
	pixelData := NewBlankImage(cols, rows, color.NRGBA{0, 0, 0, 255}) //color for first pixl canvas
